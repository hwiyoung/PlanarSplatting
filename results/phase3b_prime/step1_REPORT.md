...
![Depth View 04](images/depth_view04.png)

### Normal 렌더링

- **View 04** (`normal_view04.png`): 지붕 면의 수평 법선(연두색)과 벽면의 수직 법선(갈색/적색) 구분이 명확. GT 대비 프리미티브 법선이 더 균일하고 면 단위로 일관됨 — 평면 가정에 의한 법선 정규화 효과.

![Normal View 04](images/normal_view04.png)

### RGB 렌더링 (L_photo 신규)

- **View 04** (`rgb_view04.png`): 학습된 RGB와 GT RGB 비교. 건물 색조와 도로 색상이 GT와 유사하게 학습됨. 프리미티브 단위의 색상이므로 세밀한 텍스처 재현은 제한적이나 건물 식별은 가능. PSNR 15.0dB.

![RGB View 04](images/rgb_view04.png)

- **View 00** (oblique): GT RGB와 렌더링 RGB 비교. 건물 측면 색상, 지붕 상단 색조가 대체로 일치.

![RGB View 00](images/rgb_view00.png)
...
| 뷰 | Depth | Normal | RGB | Semantic |
|----|-------|--------|-----|----------|
| View 00 | ![](images/depth_view00.png) | ![](images/normal_view00.png) | ![](images/rgb_view00.png) | ![](images/semantic_view00.png) |
| View 04 | ![](images/depth_view04.png) | ![](images/normal_view04.png) | ![](images/rgb_view04.png) | ![](images/semantic_view04.png) |
| View 08 | ![](images/depth_view08.png) | ![](images/normal_view08.png) | ![](images/rgb_view08.png) | ![](images/semantic_view08.png) |
